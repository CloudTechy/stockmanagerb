                            ...
                            <table  class="table table-bordered table-small table-hover table-striped dataTable" >
                                ...
                                <tbody id="body">
                                    <tr v-for = "purchasedetail,index in pageLoader(current_page)">
                                        <td class="text-capitalize">{{  purchasedetail.vendor }}</td>
                                        <td class="text-capitalize">{{  purchasedetail.product }}</td>
                                ...
                                <tr v-if = "pageLoader(current_page).length > 0">
                                    <td colspan="2">
                                       <span class="small font-weight-bold text-success"> {{ "Total quantities for " + pageLoader(current_page).length + " product(s)" }}</span>
                                    </td>
                                    <td colspan="6">
                                ...
                                <tr v-if = "pageLoader(current_page).length > 0">
                                    <td colspan="4">
                                       ...
                                       <span class="small font-weight-bold text-success"> {{ "Total purchases for " + pageLoader(current_page).length + " product(s)" }}</span>
                                    </td>
                                    <td colspan="1">
...
<script>
    ...
    export default {
        ...
        methods: {
            loadPurchaseDetails(){
                this.form.get('./api/purchasedetails')
                .then( response => {
            ...
            pageLoader(pageNumber){
                ...
                this.loading = false;
                var data = this.$root.myFilter(this.purchasedetails,this.search)
