                        ...
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                          ...
                          <li ref = 'product' v-if ="product != undefined" v-for = "product,index in  $root.myFilter(cart,search)" class="item">
                            ...
                            <div class="product-info ml-0">
                              ...
                              <span  class="text-primary product-description small">Quantity</span>
                              <h3 href="javascript:void(0)" class="users-list-name font-weight-bold"> {{'Product ID: ' + product.id }} </h3>
                              <span class="badge badge-warning float-right">Subtotal: <span style="text-decoration: line-through">N</span> {{$root.numeral(product.price * product.quantity) }}</span>
